...
<div class="blog-container">
    <div class="container">
        ...
        <div class="blog-header">
            <h1>Blog</h1>
            <p>Insights, updates, and expert knowledge from the world of fuel management and telemetry</p>
        </div>
        ...
        <div class="blog-search">
            <form action="/blog/search" method="GET" class="search-form">
                <div class="search-input-group">
                    <input type="text" name="q" placeholder="Search articles..." value="<?php echo isset($searchQuery) ? htmlspecialchars($searchQuery) : ''; ?>" required>
                    ...
                    <?php if ($totalPages > 1): ?>
                        <div class="blog-pagination">
                            <?php if ($currentPage > 1): ?>
                                <a href="/blog?page=<?php echo $currentPage - 1; ?>" class="page-link prev">
                            ...
                            <?php if ($currentPage < $totalPages): ?>
                                <a href="/blog?page=<?php echo $currentPage + 1; ?>" class="page-link next">
